"""
Django settings for vsxza_45160 project.
...
WSGI_APPLICATION = "vsxza_45160.wsgi.application"
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "vsxza_45160 API",
    "DESCRIPTION": "API documentation for vsxza_45160 App",
    "VERSION": "v1",
}
